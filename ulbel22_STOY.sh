...
# write
echo "Test of STOY Quicksort with worst case values"
echo "Test of STOY Quicksort with worst case values" >>results.txt
echo "Please wait..."
...
for((NoOfValues=1;NoOfValues<=50;NoOfValues++))
  do
    ...
    #sorte the created numbers
      veriwell ulbel22_STOY.v > output.txt
...
echo "" >>results.txt
echo ""
echo "Test of STOY Quicksort with random values"
echo "Test of STOY Quicksort with random values" >>results.txt
echo "Please wait..."
noValideNo=0
