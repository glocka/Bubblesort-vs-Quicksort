...
MAIN    LDA RF 0xFE     ;stack pointer
        LDA R0 0
        LDA R1 1        ;constant 1
        LDA RA ARRAY    ;array
...
M0      LD R3 0xFE
        ...
        ST R0 0xFE
        BZ R3 SRT
        STX R3 RA R4     ;STI R3 R2
        ADD R4 R4 R1     ;ADD R2 RA R4
        BZ R0 M0                 
...
Q1      LDX R7 RA R4
        LDX RD RA R6
                        ;ADD R8 RA R4	;arr_pointer1 = array + pivot
...
Q3      LDX R7 RA R5
        LDX RD RA R4
                        ;ADD R8 RA R5	;arr_pointer1 = array + j
...
Q6      LDX R7 RA R6
        LDX RD RA R5
                        ;ADD R8 RA R6  	;arr_pointer1 = array + i
                        ;ADD R9 RA R5  	;arr_pointer = array + j
 	                      ;LDI R7 R8       ;swap = *arr_pointer1
                        ;LDI RD R9       ;swap2 = *arr_pointer2
        STX RD RA R6    ;*arr_pointer1 = swap2
        STX R7 RA R5       ;*arr_pointer2 = swap
        BZ R0 Q0        ;goto Q0
...
SWP     LDX R7 RA R4
        LDX RD RA R5
                        ...
                        ;LDI R7 R8       ;swap = *arr_pointer1
                        ;LDI RD R9       ;swap2 = *arr_pointer2
        STX RD RA R4    ;*arr_pointer1 = swap2
        STX R7 RA R5    ;*arr_pointer2 = swap
